...
<div class="hero-block hero-image" style="background-image: url(/images/clients/featured/hero-fairmont.jpg);background-position: center center;">
    <div class="container">
        <div class="hero-content">
            <div class="text-block">
                <h1>{!! $translate->token('h_fairmont') !!}</h1>
                <h2>{!! $translate->token('text_fairmont') !!}</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
	...
	<div class="content-block">
		<div class="text-block">
			<h2>{!! $translate->token('h_scentfairmont') !!}</h2>
			<p>{!! $translate->token('text_scentfairmont') !!}</p>
		</div>
	</div>
	...
	<div class="content-block">
		...
		<div class="grid square large">
           ...
           <img src="/images/clients/featured/tile-fairmont-01.jpg" alt="{!! $translate->token('h_fairmont', false) !!}" />
							</div>
						</div>
					</div>
				</div>
			...
			<div class="box dark">
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
           <img src="/images/clients/featured/tile-fairmont-02.jpg" alt="{!! $translate->token('h_fairmont', false) !!}" />
							</div>
						</div>
					</div>
				</div>
