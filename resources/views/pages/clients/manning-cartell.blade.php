...
<div class="hero-block hero-image" style="background-image: url(/images/clients/featured/hero-manning-cartell.jpg);background-position: center center;">
	<div class="container">
		<div class="hero-content">
			<div class="text-block">
				<h1>{!! $translate->token('h_manningcartell') !!}</h1>
				<h2>{!! $translate->token('text_manningcartell') !!}</h2>
			</div>
		</div>
	</div>
</div>
					...
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/clients/featured/tile-manning-cartell-01.jpg" alt="{!! $translate->token('h_signaturescent', false) !!}">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="box dark">
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/clients/featured/tile-manning-cartell-02.jpg" alt="{!! $translate->token('h_signaturescent', false) !!}">
							</div>
						</div>
					</div>
				</div>
