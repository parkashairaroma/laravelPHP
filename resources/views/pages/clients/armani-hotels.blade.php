...
<div class="hero-block hero-image" style="background-image: url(/images/clients/featured/hero-armani-hotels.jpg);background-position: center center;">
	<div class="container">
		<div class="hero-content">
			<div class="text-block">
				<h1>{!! $translate->token('h_armanihotels') !!}</h1>
				<h2>{!! $translate->token('text_armanihotels') !!}</h2>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
	...
	<div class="content-block">
		<div class="text-block">
			<h2>{!! $translate->token('h_scentarmani') !!}</h2>
			<p>{!! $translate->token('text_scentarmani') !!}</p>
		</div>
	</div>

	<div class="content-block">
		<img src="/images/clients/featured/banner-armani-hotels.jpg" alt="{!! $translate->token('h_armanihotels', false) !!}">
	</div>
					...
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/clients/featured/tile-armani-hotels-01.jpg" alt="{!! $translate->token('h_scentarmani', false) !!}">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="box dark">
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/clients/featured/tile-armani-hotels-02.jpg" alt="{!! $translate->token('h_scentarmani', false) !!}">
							</div>
						</div>
					</div>
				</div>
