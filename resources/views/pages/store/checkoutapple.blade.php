...
<div class="container">
    ...
    @if ($shippingRestrict == false && $addressbookcount > 0)        
		...
		@if ($shippingRestrict == true && $addressbookcount > 0)
      ...
      <li>
            ...
            <div class="payment-tab" id="payment-tab-paypal" @if ($paymentMethod !='paypal' ) style="display: none" @endif>
                <div class="grid large input-grid ig-a">
                    ...
                    <p>
                        Upon clicking 'Pay with PayPal' you will be taken to a secure PayPal page where you can enter your payment details. Once PayPal payment is complete, you will be returned to the Air Aroma website.
                    </p>
                </div>
