	...
	<div class="container">
		<div class="hero-content">
			<div class="text-block">
				<h1>{!! $translate->token('h_offices') !!}</h1>
				<h2>{!! $translate->token('text_offices') !!}</h2>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
				...
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-icon">
								<img src="/images/industry/icon-offices.png" alt="{!! $translate->token('h_offices', false) !!}">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/industry/tile-offices.jpg" alt="{!! $translate->token('h_offices', false) !!}">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_scentingspaces') !!}</h2>
			<p>{!! $translate->token('text_scentingspaces') !!}</p>
		</div>
	</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_enhancedperformance') !!}</h2>
			<p>{!! $translate->token('text_enhancedperformance') !!}</p>
		</div>
	</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_increasedefficiency') !!}</h3>
							<p>{!! $translate->token('text_increasedefficiency') !!}</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_improvedenvironment') !!}</h3>
							<p>{!! $translate->token('text_improvedenvironment') !!}</p>
						</div>
					</div>
				</div>
			</div>
