	...
	<div class="container">
		<div class="hero-content">
			<div class="text-block">
				<h1>{!! $translate->token('h_medical') !!}</h1>
				<h2>{!! $translate->token('text_medical') !!}</h2>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
				...
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-icon">
								<img src="/images/industry/icon-medical.png" alt="{!! $translate->token('h_medical', false) !!}">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/industry/tile-medical.jpg" alt="{!! $translate->token('h_medical', false) !!}">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_scentingpractice') !!}</h2>
			<p>{!! $translate->token('text_scentingpractice') !!} </p>
		</div>
	</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_revitalizeair') !!}</h2>
			<p>{!! $translate->token('text_revitalizeair') !!}</p>
		</div>
	</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_antibacterial') !!}</h3>
							<p>{!! $translate->token('text_antibacterial') !!}</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_calmingnerves') !!}</h3>
							<p>{!! $translate->token('text_calmingnerves') !!}</p>
						</div>
					</div>
				</div>
			</div>
