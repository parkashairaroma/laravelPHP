	...
	<div class="container">
		<div class="hero-content">
			<div class="text-block">
				<h1>{!! $translate->token('h_apartments') !!}</h1>
				<h2>{!! $translate->token('text_apartments') !!}</h2>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
	...
	<div class="content-block">
		<div class="grid square large">
				...
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-icon">
           <img src="/images/industry/icon-apartment-communities.png" alt="{!! $translate->token('h_apartments', false) !!}" />
							</div>
						</div>
					</div>
				</div>
           ...
           <img src="/images/industry/tile-industry-apartment-communities.jpg" alt="{!! $translate->token('h_apartments', false) !!}" />
							</div>
						</div>
					</div>
				</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_scentapartments') !!}</h2>
			<p>{!! $translate->token('text_scentapartments') !!}</p>
		</div>
	</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_luxury') !!}</h3>
							<p>{!! $translate->token('text_luxury') !!}</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_sellapartments') !!}</h3>
							<p>{!! $translate->token('text_sellapartments') !!}</p>
						</div>
					</div>
				</div>
			</div>
