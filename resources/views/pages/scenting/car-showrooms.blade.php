	...
	<div class="container">
		<div class="hero-content">
			<div class="text-block">
				<h1>{!! $translate->token('h_carshowrooms') !!}</h1>
				<h2>{!! $translate->token('text_carshowrooms') !!}</h2>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
				...
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-icon">
								<img src="/images/industry/icon-car-showrooms.png" alt="{!! $translate->token('h_carshowrooms', false) !!}">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/industry/tile-car-showrooms.jpg" alt="{!! $translate->token('h_carshowrooms', false) !!}">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_cardealerships') !!}</h2>
			<p>{!! $translate->token('text_cardealerships') !!}</p>
		</p>
		</div>
	</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_automotivescents') !!}</h2>
			<p>{!! $translate->token('text_automotivescents') !!}</p>
		</div>
	</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_prolongedstay') !!}</h3>
							<p>{!! $translate->token('text_prolongedstay') !!}</p>
						</div>
					</div>
				</div>
			</div>
