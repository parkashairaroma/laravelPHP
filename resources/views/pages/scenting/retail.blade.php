	...
	<div class="container">
		<div class="hero-content">
			<div class="text-block">
				<h1>{!! $translate->token('h_retail') !!}</h1>
				<h2>{!! $translate->token('text_retail') !!}</h2>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
				...
				<div class="box-cell">
					<div class="tile">
						<div class="tile-content">
							<div class="tile-icon">
								<img src="/images/industry/icon-retail.png" alt="{!! $translate->token('h_retail', false) !!}">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="tile">
						<div class="tile-content">
							<div class="tile-image">
								<img src="/images/industry/tile-retail.jpg" alt="{!! $translate->token('h_retail', false) !!}">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_enhanceretail') !!}</h2>
			<p>{!! $translate->token('text_enhanceretail') !!}</p>
		</div>
	</div>
	...
	<div class="content-block cb-b">
		<div class="text-block tb-b">
			<blockquote>
				<em>
					<p>{!! $translate->token('h_fragrancefacts') !!}</p>
					<p>{!! $translate->token('text_fragrancefacts') !!}</p>
				</em>
			</blockquote>
		</div>
	</div>
	...
	<div class="content-block cb-a">
		<div class="text-block">
			<h2>{!! $translate->token('h_bespokescents') !!}</h2>
			<p>{!! $translate->token('text_bespokescents') !!}</p>
		</div>
	</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_memorableexperience') !!}</h3>
							<p>{!! $translate->token('text_memorableexperience') !!}</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box-cell">
					<div class="box-content">
						<div class="text-block">
							...
							<h3>{!! $translate->token('h_increasedsales') !!}</h3>
							<p>{!! $translate->token('text_increasedsales') !!}</p>
						</div>
					</div>
				</div>
			</div>
